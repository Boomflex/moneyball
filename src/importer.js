...
export const HEADER_ALIASES = new Map(Object.entries({
  ...
  "possessionwonper90": ["Possession Won per 90", "Possession Won"],
  "possessionlostper90": ["Possession Lost per 90", "Possession Lost"],
  "passescompletedper90": ["Passes Completed per 90"],
  "passesattemptedper90": ["Passes Attempted per 90", "Passes Attempted"],
  ...
  "pressurescompletedper90": ["Pressures Completed per 90", "Pressures Won per 90", "Pressures Won", "Pres C/90"],
  "pressuresattemptedper90": ["Pressures Attempted per 90", "Pressures Attempted", "Pres A/90"],
  "blocksper90": ["Blk/90", "Shts Blckd/90", "Blocks per 90"],
  "xassistsper90": ["xA/90", "xAssists per 90", "Expected Assists per 90"],
  "chancescreatedper90": ["Chances Created per 90"],
  "openplaykeypassesper90": ["Open Play Key Passes per 90", "Open Play Key Passes", "Open-Play Key Passes"],
  ...
  "shotsper90": ["Shot/90", "Shots per 90", "Shots"],
  ...
  "keypassesper90": ["Open Play Key Passes per 90", "Open Play Key Passes", "Open-Play Key Passes", "Key Passes per 90", "Key Passes"],
  ...
  "expectedassistsper90": ["xA/90", "xAssists per 90", "Expected Assists per 90", "Expected Assists"],
  "expectedgoalsper90": ["NP-xG/90", "Non Penalty xGoals per 90", "Expected Goals per 90", "Expected Goals"],
  "goalsper90": ["Goals per 90 minutes", "Goals per 90", "Goals"],
