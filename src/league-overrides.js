...
const OVERRIDES = [
  ...
  {
    names: ["Scottish Premiership"],
    baseLeague: "Norwegian Premier Division",
    strengthDelta: 0,
    note: "Derived baseline: workbook has no native Scottish Premiership data, so it uses Norwegian Premier Division until a dedicated baseline exists.",
  },
  {
...
const BASED_IN_LEAGUE_ALIASES = new Map([
  ...
  ["firstdivision|esp", "Spanish First Division"],
  ["firstdivision|spain", "Spanish First Division"],
  ["firstleague|cro", "Croatian First League"],
  ["firstleague|croatia", "Croatian First League"],
  ...
  ["seconddivision|esp", "Spanish Second Division"],
  ["seconddivision|spain", "Spanish Second Division"],
  ["seriea|ita", "Italian Serie A"],
  ["seriea|italy", "Italian Serie A"],
  ["seriebkt|ita", "Italian Serie B"],
  ["seriebkt|italy", "Italian Serie B"],
  ["superleague|tur", "Turkish Super League"],
  ...
  ["williamhillpremiership|scotland", "Scottish Premiership"],
]);
